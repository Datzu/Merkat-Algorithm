...
public class Utils {
	...
	public static final int maxNCustomers = 25; // tamany màxim de clients al merkat
	public static final int maxGenCustomers = 5;
	...
	public static final int minimeGenCustomers = 1000; // temps minim per generar clients
