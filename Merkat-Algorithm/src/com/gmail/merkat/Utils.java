...
/**
 * Classe per definir els paràmetres i els limitadors que hi hauran a
 * l'algorisme
 * 
...
public class Utils {
	...
	public static final int maxNQueueCustomers = 5; // tamany màxim de cua de
													// clients per caixa
	public static final int maxNCustomers = 300; // tamany màxim de clients al
													// merkat
	public static final int maxGenCustomers = 10;

	public static final int minTimeScan = 10; // temps minim que tarda el caixer
												// a pasar el producte a la
												// cinta
	public static final int maxTimeScan = 1000; // temps maxim que tarda el
												// caixer a pasar el producte a
												// la cinta
